        ...
        <div>
          <section className="relative gap-8 md:grid md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="mx-auto my-12 flex max-w-md flex-col md:ml-4 md:max-w-sm lg:col-span-2 lg:mx-auto">
              <h1 className="mt-4 text-6xl leading-snug text-secondary lg:text-7xl lg:leading-snug ">
                Crowdfund climate projects
              </h1>
              <p className="font-body mt-8 text-lg text-gray-50">
              ...
              <div className="mt-8 flex flex-row gap-4">
                <a
                  ...
                  className="btn text-secondary  outline-secondary/[.65] hover:outline-2 active:bg-secondary/[.55]"
                >
                  Apply for funding
                </a>
                <Link
                  href="/projects"
                  className="btn bg-secondary  text-gray-800 hover:bg-secondary/[.95] active:bg-secondary/[.55]"
                >
                  Browse projects
                </Link>
              </div>
